...
public static class EndpointExtensions
{
    public static WebApplication MapApiEndpoints(this WebApplication app)
    {
        ...
        app.MapGet("/api/cards/search", async (
            string q,
            int? pageSize,
            ProtoContracts.CardSearch.CardSearchClient cardSearchClient,
            CancellationToken cancellationToken) =>
        {
            ...
            return Results.Ok(MapCards(reply.Cards));
        })
        .WithName("SearchCards");

        app.MapPost("/api/cards/search/advanced", async (
            ScryfallContracts.CardQuerySearch body,
            ProtoContracts.CardSearch.CardSearchClient cardSearchClient,
            CancellationToken cancellationToken) =>
        {
            var request = ToProtoRequest(body);
    ...
    private static IEnumerable<object> MapCards(IEnumerable<ProtoContracts.CardItem> cards) =>
    ...
    private static ProtoContracts.AdvanceSearchCardsRequest ToProtoRequest(ScryfallContracts.CardQuerySearch q)
    {
    ...
    private static ProtoContracts.ComparisonOperator MapOp(ScryfallContracts.ComparisonOperator op) =>
