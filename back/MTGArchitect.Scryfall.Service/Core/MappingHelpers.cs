...
internal static class MappingHelpers
{
    ...
    internal static SearchContracts.CardQuerySearch ToCardQuerySearch(AdvanceSearchCardsRequest r)
    {
    ...
    internal static SearchContracts.ComparisonOperator MapOp(ComparisonOperator op) => op switch
    {
    ...
    internal static SearchContracts.CardRarity MapRarity(CardRarity r) => r switch
    {
    ...
    internal static SearchContracts.CardGame MapGame(CardGame g) => g switch
    {
    ...
    internal static SearchContracts.CardFormat MapFormat(CardFormat f) => f switch
    {
    ...
    internal static SearchContracts.UniqueStrategy MapUnique(UniqueStrategy u) => u switch
    {
    ...
    internal static SearchContracts.SortOrder MapOrder(SortOrder o) => o switch
    {
